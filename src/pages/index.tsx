      ...
      >
        {isMobile ? (
          <>
            ...
            {menuOpen && (
              ...
              >
                <li className="w-full px-4 py-2 hover:bg-black dark:hover:bg-black rounded">
                  <ScrollLink
                    to="welcomeSection"
                    smooth={true}
                    duration={500}
                ...
                <li className="w-full px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-900 rounded">
                  <ScrollLink
                    to="speakersSection"
                    smooth={true}
                    duration={500}
        ...
        <div className="flex items-center space-x-4">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            />
            <div className="w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-900 peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
          </label>
          {/* Profile Icon */}
          <div
